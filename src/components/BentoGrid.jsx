...
export default function BentoGrid() {
  return (
    <section id="rituals" style={{ padding: '100px 24px', background: '#2C2825', position: 'relative' }}>
      <div style={{ position: 'absolute', inset: 0, backgroundImage: `url(${import.meta.env.BASE_URL}images/texture-bento.jpg)`, backgroundSize: '900px auto', backgroundPosition: 'top left', backgroundRepeat: 'repeat', opacity: 0.5, filter: 'brightness(0.65)', pointerEvents: 'none', zIndex: 0 }} />
