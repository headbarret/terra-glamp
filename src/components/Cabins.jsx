...
export default function Cabins() {
  ...
  return (
    <section id="cabins" style={{ padding: '120px 0 100px', background: '#2C2825', position: 'relative' }}>
      <div style={{ position: 'absolute', inset: 0, backgroundImage: 'url(/images/texture-cabins.jpg)', backgroundSize: '900px auto', backgroundPosition: 'top left', backgroundRepeat: 'repeat', opacity: 0.5, filter: 'brightness(0.65)', pointerEvents: 'none', zIndex: 0 }} />
